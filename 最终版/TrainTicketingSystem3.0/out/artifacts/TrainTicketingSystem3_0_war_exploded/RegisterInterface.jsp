...
<!--注册开始-->
<div class="reg">
    <form action="http://localhost:8080/TrainTicketingSystem/RegisterServlet" method="post" name="form1" id="form1">
        <dl>
            ...
            <dd><span class="title">身份认证：</span>
                <input type="radio"  id="IS_stu" name="rb_stu" value="1" checked="CHECKED" />学生<label for="Is_stu"></label>
                <input type="radio" id="Isnot_stu" name="rb_stu" value="0" /><label for="Isnot_stu">非学生</label>　
            </dd>
        </dl>
        <dl>
        ...
        <div class="f_reg_but"><input id="button" name="button" type="submit" value="注册" class="r_button"/><span class="clew_txt">如果您已有帐号，可<a href="http://localhost:8080/TrainTicketingSystem/LoginInterface.jsp">直接登录</a></span></div>
    </form>
</div>
<!--注册结束-->
...
<%
    ...
    if (successful!=null&&successful.equals("null")){
        %>
<script>
alert("注册失败请您再试一次！");
</script>
