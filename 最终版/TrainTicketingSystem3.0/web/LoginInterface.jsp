...
<div id="login_background">
    ...
    <div id="login_content">
        <form id="login" action="http://localhost:8080/TrainTicketingSystem/LoginServlet" method="post">
            <h1>账号登录</h1>
            <fieldset id="inputs">
            ...
            <fieldset id="actions">
                ...
                <a href="http://localhost:8080/TrainTicketingSystem/RegisterInterface.jsp">注册账号</a>
            </fieldset>
        </form>
    </div>
